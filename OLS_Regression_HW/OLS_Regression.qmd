...
The formula with appropriate variables from our task is as followed: 

$$
\log(\text{Median Home Value}) = \beta_0 + \log\beta_1(\text{Poverty}) + \beta_2(\text{Education}) + \beta_3(\text{Vacancy}) + \beta_4(\text{Single Units}) + \varepsilon
$$
